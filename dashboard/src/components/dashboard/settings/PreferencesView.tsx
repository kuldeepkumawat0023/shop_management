  ...
  return (
    <div className="flex flex-col h-full bg-background p-4 md:p-6 lg:p-8 overflow-y-auto custom-scrollbar w-full mx-auto max-w-5xl">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-8">
        <div>
          <h2 className="text-3xl font-black text-on-surface tracking-tight mb-1">Preferences</h2>
          <p className="text-sm font-medium text-on-surface-variant">Customize how the application behaves for you.</p>
        </div>
      ...
      <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-3xl p-6 lg:p-8 shadow-sm h-fit">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="flex flex-col gap-1.5 w-full">
            <label className="text-sm font-bold text-on-surface">Currency</label>
          ...
          <div className="flex flex-col gap-1.5 w-full">
            <label className="text-sm font-bold text-on-surface">Timezone</label>
          ...
          <div className="flex flex-col gap-1.5 w-full mt-2">
            <label className="text-sm font-bold text-on-surface">Default Receipt Printer Format</label>
            <select defaultValue="A4" className="flex w-full h-10 rounded-xl bg-surface border border-outline-variant/30 px-3 text-sm text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all appearance-none">
              <option value="A4">A4 Size (PDF)</option>
          ...
          <div className="col-span-1 flex flex-col gap-1.5 w-full justify-center mt-8">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="text-sm font-bold text-on-surface">Enable Email Notifications</span>
            </label>
          </div>
        </div>
      </div>
