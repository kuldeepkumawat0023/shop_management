...
router.post('/create', requirePermission(PERMISSIONS.BRANDS_CREATE), createBrand);
router.get('/all', requirePermission(PERMISSIONS.BRANDS_VIEW), getBrands);
router.put('/update/:id', requirePermission(PERMISSIONS.BRANDS_UPDATE), updateBrand);
